export const LogoCarousel = () => {
  return (
    <div className="relative box-border caret-transparent min-h-[auto] min-w-[auto] z-0 overflow-hidden py-2.5">
      <div role="region" className="relative box-border caret-transparent">
        <div className="relative box-border caret-transparent z-0 overflow-hidden">
          <div
            role="presentation"
            className="box-border caret-transparent gap-x-10 flex h-full gap-y-10 translate-x-[-9394.35px] md:gap-x-16 md:gap-y-16"
          >
            <div
              role="group"
              aria-label="1 of 39"
              className="relative items-center box-border caret-transparent flex shrink-0 h-10 justify-center list-none min-h-[auto] min-w-[auto] md:h-16"
            >
              <img
                src="https://cdn.prod.website-files.com/674703d2af36853f65da67e0/6885efb8de6485b41ef30512_Logo_edvive_mono.svg"
                alt=""
                className="box-border caret-transparent block h-full max-w-full min-h-[auto] min-w-[auto] object-contain align-bottom w-full md:object-fill md:w-auto"
              />
            </div>
            <div
              role="group"
            ...
            >
              <img
                src="https://cdn.prod.website-files.com/674703d2af36853f65da67e0/699edc572d2132bc29e673b6_Logo_Wefi_ mono.svg"
                alt=""
                className="box-border caret-transparent block h-full max-w-full min-h-[auto] min-w-[auto] object-contain align-bottom w-full md:object-fill md:w-auto"
              />
            </div>
            ...
            >
              <img
                src="https://cdn.prod.website-files.com/674703d2af36853f65da67e0/699edc87359d20b3995f03cc_Logo_FMS_ mono.svg"
                alt=""
                className="box-border caret-transparent block h-full max-w-full min-h-[auto] min-w-[auto] object-contain align-bottom w-full md:object-fill md:w-auto"
              />
            </div>
      ...
      <div role="region" className="relative box-border caret-transparent">
        <div className="relative box-border caret-transparent z-0 overflow-hidden">
          <div
            role="presentation"
            className="box-border caret-transparent gap-x-10 flex h-full gap-y-10 translate-x-[-7298.93px] md:gap-x-16 md:gap-y-16"
          >
            <div
              role="group"
              aria-label="1 of 27"
