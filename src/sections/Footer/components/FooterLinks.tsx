                ...
                >
                  ...
                  <div className="text-sm items-center box-border caret-transparent flex shrink-0 h-3.5 justify-center leading-[21px] min-h-[auto] min-w-[auto] text-left mt-1 md:text-base md:[align-items:normal] md:block md:shrink md:h-auto md:justify-normal md:leading-6 md:text-start md:mt-0">
                    <img
                      ...
                      alt=""
                      className="text-sm box-border caret-transparent block h-3.5 leading-[21px] max-w-full min-h-[auto] min-w-[auto] text-left align-middle md:text-base md:inline-block md:h-auto md:leading-6 md:min-h-0 md:min-w-0 md:text-start"
                    />
                  </div>
                </a>
              </div>
              ...
              >
                <div className="text-sm box-border caret-transparent h-[30px] leading-[21px] min-h-[auto] min-w-[auto] text-left overflow-visible md:text-base md:leading-6 md:text-center md:overflow-hidden">
                  <img
                    ...
                    alt=""
                    className="text-sm box-border caret-transparent inline-block leading-[21px] max-w-full text-left align-middle md:text-base md:leading-6 md:text-center"
                  />
                </div>
                ...
                <div className="text-sm box-border caret-transparent gap-x-0 flex flex-col leading-[21px] min-h-[auto] min-w-[auto] gap-y-0 text-left md:text-base md:gap-x-2.5 md:flex-row md:leading-6 md:gap-y-2.5 md:text-center">
                  ...
                  <div className="text-sm items-center box-border caret-transparent flex shrink-0 h-3.5 justify-center leading-[21px] min-h-[auto] min-w-[auto] text-left mt-1 md:text-base md:[align-items:normal] md:block md:shrink md:h-auto md:justify-normal md:leading-6 md:text-center md:mt-0">
                    <img
                      ...
                      alt=""
                      className="text-sm box-border caret-transparent block h-3.5 leading-[21px] max-w-full min-h-[auto] min-w-[auto] text-left align-middle md:text-base md:inline-block md:h-auto md:leading-6 md:min-h-0 md:min-w-0 md:text-center"
                    />
                  </div>
                </div>
              </a>
